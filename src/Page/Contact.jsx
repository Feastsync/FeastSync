                ...
                <section className='contact-infol-leftwrapper'>
                    <div className="contact-info-btn1">
                        ...
                        <div className='contact-btn1-right'>
                            <h1>Location</h1>
                            <p>161/162 Muyibi Street,Olodi- <br />Apapa, Lagos </p>
                        </div>
                        </div> 
                     <div className="contact-info-btn1">
                        <div className='contact-btn1-left'>
                        ...
                        <div className='contact-btn1-right'>
                            <h1>Phone</h1>
                            <p>080-3000-800 <br /> 080-3000-700 </p>
                        </div>
                        </div> 
                </section>
            </section>
            <section className='contact-info-right'>
                <section className='contact-info-rightwrapper'>
                    ...
                    <section className='contact-info-rightdown'>
                        <h1>Leave a Note</h1>
                        <textarea placeholder="Your message here" className='contact-rightdown-text' />
                        <button className="contact-info-rightdown-btn">Send Message</button>
                    </section>
                </section>
            </section>
        </section>
